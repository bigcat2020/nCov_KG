...
from data.data_loader import read_vocab, read_category, batch_iter, process_file, build_vocab, process_str
from data.data_augment import data_augment
...
if __name__ == '__main__':
    if len(sys.argv) != 2 or sys.argv[1] not in ['train', 'test','data']:
        raise ValueError("""usage: python run_rnn.py [train / test / data]""")
