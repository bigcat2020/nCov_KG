...
class MainFrame(tk.Frame):
    ...
    def __init__(self, root, url):
        ...
        # BrowserFrame
        self.browser_frame = BrowserFrame(self, url, self.navigation_bar)
        ...
        # Pack MainFrame
        #self.pack(fill=tk.BOTH, expand=tk.YES, pady=80)
...
class BrowserFrame(tk.Frame):
    ...
    def __init__(self, master, url, navigation_bar=None):
